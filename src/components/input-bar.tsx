...
export default function InputBar({onOpenPopup}: inputBarProps){
    ...
    return(
        <div className="absolute bottom-0 left-0 right-0 flex gap-2 py-3 px-3 bg-blue-200 rounded-2xl ml-3 mr-3 mb-4">
            ...
            <button onClick={(e) => {e.stopPropagation(); onOpenPopup();}} className="bg-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-gray-100">
                <Paperclip width={20}/>
            </button>
